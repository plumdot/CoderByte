...
So for example: if strArr is ["hello", "world", "before", "all"] your 
output should be world because "before" is 6 letters long, and "hello" 
and "world" are both 5, but the output should be world because it appeared 
as the last 5 letter word in the array. 
...
*/
var myStrArr = ["hello", "world", "after", "all"];

function ThirdGreatest(strArr){

	// sort the array by length of each element
...
console.log(ThirdGreatest(myStrArr));
