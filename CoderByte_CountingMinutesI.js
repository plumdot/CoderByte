/*
CoderByte: CountingMinutesI

Using the JavaScript language, have the function 
CountingMinutesI(str) take the str parameter being passed 
...
var myStr = "9:00am-10:00am";
var myStr = "1:00pm-11:00am";

function CountingMinutesI(str){

}

console.log(CountingMinutesI(myStr));
